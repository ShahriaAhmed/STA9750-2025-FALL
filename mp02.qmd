...
ggplot(viz1_data, aes(x = avg_composite_score, y = rent_burden_change)) +
  ...
  labs( #adjust labels, annotations, font, color ,size etc
    ...
    subtitle = "Size shows population growth, Green shows all 4 YIMBY criteria met",
    x = "Average Housing Growth Score (2014-2023)",
    y = "Change in Rent Burden Index (2023-2014)",
    caption = "YIMBY is defined by high early rent burden + drop in rent burden + population growth + high housing growth"
  ) +
...
ggplot(comparison_data, aes(x = reorder(NAME, -rent_burden), y = rent_burden, fill = period)) +
  ...
  labs(#labels, titles, axis, captions
    ...
    subtitle = "All cities shown had high early rent burden, a growing population, and above average housing growth",
    x = "",
    y = "Rent Burden Index",
  ...
  theme(#adjust font size, color and padding 
    ...
    plot.caption = element_text(size = 16, margin = margin(b = 5)),
    legend.position = "top",
    legend.text = element_text(size = 14), #increase legend item text size
